...
class H1FlatTerrainPolicy(PolicyController):
    ...
    def __init__(
        ...
        if usd_path == None:
            usd_path = BASEDIR + "/g1_description/g1_29dof_rev_1_0_lidar.usd"
        super().__init__(name, prim_path, root_path, usd_path, position, orientation)
        self.load_policy(
            BASEDIR + "/assets/weights/pre_train/policy.pt",
            BASEDIR + "/Isaac/Samples/Policies/H1_Policies/h1_env.yaml",
        )
